...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    experienceType: Schema.Attribute.Enumeration<
      [
        'education',
        'work',
        'freelance',
...
export interface ApiGuestbookMessageGuestbookMessage
  extends Struct.CollectionTypeSchema {
  collectionName: 'guestbook_messages';
  info: {
    displayName: 'Guestbook Message';
    pluralName: 'guestbook-messages';
    singularName: 'guestbook-message';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::guestbook-message.guestbook-message'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    featuredArticles: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    featuredExperiences: Schema.Attribute.Relation<
      'oneToMany',
      'api::experience.experience'
    >;
    featuredProjects: Schema.Attribute.Relation<
      ...
      'api::project.project'
    >;
    featuredSkills: Schema.Attribute.Relation<'oneToMany', 'api::skill.skill'>;
    fullName: Schema.Attribute.String;
    headline: Schema.Attribute.String;
    heroCtaPrimary: Schema.Attribute.Component<'shared.cta', false>;
    heroCtaSecondary: Schema.Attribute.Component<'shared.cta', false>;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dashboardUrl: Schema.Attribute.String;
    gallery: Schema.Attribute.Component<'shared.gallery-image', true>;
    ...
    > &
      Schema.Attribute.Private;
    notebookResources: Schema.Attribute.Component<
      'shared.notebook-resource',
      true
    >;
...
export interface ApiShortLinkShortLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    destinationUrl: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 2048;
      }>;
    ...
    lastClickedAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTourGuideLandingPageTourGuideLandingPage
  extends Struct.SingleTypeSchema {
  collectionName: 'tour_guide_landing_pages';
  info: {
    displayName: 'Tour Guide Landing Page';
    pluralName: 'tour-guide-landing-pages';
    singularName: 'tour-guide-landing-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredTours: Schema.Attribute.Relation<
      'oneToMany',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tour-guide-landing-page.tour-guide-landing-page'
    > &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyChooseMe: Schema.Attribute.JSON;
  };
}
...
export interface ApiTourPackageTourPackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bookingContact: Schema.Attribute.Component<'shared.contact-link', true>;
    coverImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    notSuitableFor: Schema.Attribute.JSON;
    priceOption: Schema.Attribute.Component<'shared.price-option', true>;
    publishedAt: Schema.Attribute.DateTime;
    route: Schema.Attribute.Component<'shared.route-stop', true>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    shortDescription: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    suitableFor: Schema.Attribute.JSON;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatToPrepare: Schema.Attribute.JSON;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::guestbook-message.guestbook-message': ApiGuestbookMessageGuestbookMessage;
      'api::home-page.home-page': ApiHomePageHomePage;
      'api::project.project': ApiProjectProject;
      'api::short-link.short-link': ApiShortLinkShortLink;
      'api::site-setting.site-setting': ApiSiteSettingSiteSetting;
      'api::skill.skill': ApiSkillSkill;
      'api::tour-guide-landing-page.tour-guide-landing-page': ApiTourGuideLandingPageTourGuideLandingPage;
